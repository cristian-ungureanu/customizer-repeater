...
class Customizer_Repeater_Control extends WP_Customize_Control {
	...
	public function render_content() {
		...
		if ( ! empty( $options['customizer_repeater_image_control'] ) ) {
			$customizer_repeater_image_control = $options['customizer_repeater_image_control'];
		} else {
			$customizer_repeater_image_control = false;
		}

		if ( ! empty( $options['customizer_repeater_icon_control'] ) ) {
			$customizer_repeater_icon_control = $options['customizer_repeater_icon_control'];
		} else {
			$customizer_repeater_icon_control = false;
		}

		if ( ! empty( $options['customizer_repeater_title_control'] ) ) {
			$customizer_repeater_title_control = $options['customizer_repeater_title_control'];
		} else {
			$customizer_repeater_title_control = false;
		}

		if ( ! empty( $options['customizer_repeater_subtitle_control'] ) ) {
			$customizer_repeater_subtitle_control = $options['customizer_repeater_subtitle_control'];
		} else {
			$customizer_repeater_subtitle_control = false;
		}

		if ( ! empty( $options['customizer_repeater_text_control'] ) ) {
			$customizer_repeater_text_control = $options['customizer_repeater_text_control'];
		} else {
			$customizer_repeater_text_control = false;
		}

		if ( ! empty( $options['customizer_repeater_link_control'] ) ) {
			$customizer_repeater_link_control = $options['customizer_repeater_link_control'];
		} else {
			$customizer_repeater_link_control = false;
		}

		if ( ! empty( $options['customizer_repeater_shortcode_control'] ) ) {
			$customizer_repeater_shortcode_control = $options['customizer_repeater_shortcode_control'];
		} else {
				...
				<div class="customizer-repeater-general-control-repeater-container customizer-repeater-draggable">
					...
					<div class="customizer-repeater-box-content-hidden">
						...
						if ( $customizer_repeater_subtitle_control == true ) { ?>
							...
							<input type="text" value="<?php if ( ! empty( $icon->subtitle ) ) {
						...
						if ( $customizer_repeater_shortcode_control == true ) { ?>
							...
							<input type="text" value='<?php if ( ! empty( $icon->shortcode ) ) {
								echo $icon->shortcode;
